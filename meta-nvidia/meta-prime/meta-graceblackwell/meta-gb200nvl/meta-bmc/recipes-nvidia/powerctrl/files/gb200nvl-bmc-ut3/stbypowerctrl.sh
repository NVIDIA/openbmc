...
aux_cycle()
{
    ...
    # UT3.0 Workaround: Trigger aux-cycle via 3-party IO expander
    # This should be reverted once the HW got fixed in new revisions
    gpioset -m exit `gpiofind "D1_BMC_SELF_PWR_CYCLE-O"`=1
}
