...
EXTRA_OEMESON:append = " -Dnvidia-oem-device-status-from-file=disabled"
...
FILES:${PN}:append = " \
    ${datadir}/${PN}/fw_mctp_mapping.json \
...
do_install:append() {
    ...
    install -m 0644 ${WORKDIR}/fw_mctp_mapping.json ${D}${datadir}/${PN}/
