...
do_install:append() {
     ...
     install -m 0444 ${UNPACKDIR}/pcie_gpu_nsm_gpu_static_inventory_gpu.json ${D}/usr/share/entity-manager/configurations
     install -m 0444 ${UNPACKDIR}/pcie_gpu_instance_mapping.json ${D}/usr/share/entity-manager/configurations
     install -m 0444 ${UNPACKDIR}/pcie_gpu_systems_processor.json ${D}/usr/share/entity-manager/configurations
     install -m 0444 ${UNPACKDIR}/pcie_gpu_nsm_gpu_chassis.json ${D}/usr/share/entity-manager/configurations
