...
EXTRA_OECMAKE:append:gb200nvl-bmc = " -Dgb200nvl-oem-commands=1 -Dcpu-diag-enable=1 "
EXTRA_OECMAKE:append:gb200nvl-bmc-dgx = " -Dgb200nvl-oem-commands=1 -Dcpu-diag-enable=1 "
