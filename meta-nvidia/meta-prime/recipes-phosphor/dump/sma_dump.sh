...
DUMP_CFG_INPUT_FILE="/usr/share/device_sma_eid.csv"
SMA_LOG_FILE="/var/mctp-vdm-output.bin"

function help()
{
    echo "Usage: sma_dump [-h] -p <file_path> -i <dump_id>"
    echo ""
    echo "Options:"
...
function main()
{
    ...
    do
        ...
        tmpFileName="${name}_sma_dump.bin"
        mv -f $SMA_LOG_FILE "$TMP_DIR_PATH/$tmpFileName"
    done
